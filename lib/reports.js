...
Reports.prototype.timeEntriesByProject = function (options, cb) {
    ...
    if (options.is_closed === false || options.is_closed === 'no') {
...
Reports.prototype.expensesByUser = function (options, cb) {
    ...
    var url = '/people/' + options.user_id + '/expenses?from=' + options.from + '&to=' + options.to + filters;
    this.client.get(url, {}, cb);
};
...
Reports.prototype.expensesByClient = function (options, cb) {
    ...
    var url = '/clients/' + options.client_id + '/expenses?from=' + options.from + '&to=' + options.to + filters;
    this.client.get(url, {}, cb);
};
