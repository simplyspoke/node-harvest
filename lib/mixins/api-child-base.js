...
const apiBase = {
   ...
   */
  list(parentId, options, cb) {

    let uri = this.buildUri(parentId);
   ...
   */
  buildUri(parentId) {
    return `/${this.parentName}/${parentId}/${this.name}/`;
  }
};
