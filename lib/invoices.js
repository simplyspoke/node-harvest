...
Invoices.prototype.create = function(options, cb) {
	...
	invoice += '<due-at type="date">' + options.due_at + '</due-at>';
    if (typeof options.due_at_human_format !== "undefined")
	invoice += '<due-at-human-format>' + options.due_at_human_format + '</due-at-human-format>';
    if (typeof options.client_id !== "undefined")
	invoice += '<client-id type="integer">' + options.client_id + '</client-id>';
    if (typeof options.currency !== "undefined")
	invoice += '<currency>' + options.currency + '</currency>';
    if (typeof options.issued_at !== "undefined")
	invoice += '<issued-at type="date">' + options.issued_at + '</issued-at>';
    if (typeof options.subject !== "undefined")
	invoice += '<subject>' + options.subject + '</subject>';
    if (typeof options.notes !== "undefined")
	invoice += '<notes>' + options.notes + '</notes>';
    if (typeof options.number !== "undefined")
	invoice += '<number>' + options.number + '</number>';
    if (typeof options.kind !== "undefined")
	invoice += '<kind>' + options.kind + '</kind>';
    if (typeof options.projects_to_invoice !== "undefined")
	invoice += '<projects-to-invoice>' + options.projects_to_invoice + '</projects-to-invoice>';
    if (typeof options.import_hours !== "undefined")
	invoice += '<import-hours>' + options.import_hours + '</import-hours>';
    if (typeof options.import_expenses !== "undefined")
	invoice += '<import-expenses>' + options.import_expenses + '</import-expenses>';
    if (typeof options.period_end !== "undefined")
	invoice += '<period-end type="date">' + options.period_end + '</period-end>';
    if (typeof options.period_start !== "undefined")
	invoice += '<period-start type="date">' + options.period_start + '</period-start>';
    if (typeof options.expense_period_end !== "undefined")
	invoice += '<expense-period-end type="date">' + options.expense_period_end + '</expense-period-end>';
    if (typeof options.expense_period_start !== "undefined")
	invoice += '<expense-period-start type="date">' + options.expense_period_start + '</expense-period-start>';
    if (typeof options.updated_at !== "undefined")
	invoice += '<updated-at type="datetime">' + options.updated_at + '</updated-at>';
    if (typeof options.created_at !== "undefined")
	invoice += '<created-at type="datetime">' + options.created_at + '</created-at>';
    invoice += '</invoice>';
