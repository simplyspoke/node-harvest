...
InvoiceMessages.prototype.create = function(options, cb) {
	...
	invoice_message += '<body>' + options.body + '</body>';
    if (typeof options.recipients !== "undefined")
	invoice_message += '<recipients>' + options.recipients + '</recipients>';
    if (typeof options.attach_pdf !== "undefined")
	invoice_message += '<attach-pdf type="boolean">' + options.attach_pdf + '</attach-pdf>';
    if (typeof options.send_me_a_copy !== "undefined")
	invoice_message += '<send-me-a-copy type="boolean">' + options.send_me_a_copy + '</send-me-a-copy>';
