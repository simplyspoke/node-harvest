...
ClientContacts.prototype.create = function(options, cb) {
    ...
    var contact = '<contact>';
    if (typeof options.client_id !== "undefined")
	contact += '<client-id type="integer">' + options.client_id + '</client-id>';
    if (typeof options.email !== "undefined")
	contact += '<email>' + options.email + '</email>';
    if (typeof options.first_name !== "undefined")
	contact += '<first-name>' + options.first_name + '</first-name>';
    if (typeof options.last_name !== "undefined")
	contact += '<last-name>' + options.last_name + '</last-name>';
    if (typeof options.phone_office !== "undefined")
	contact += '<phone-office>' + options.phone_office + '</phone-office>';
    if (typeof options.phone_mobile !== "undefined")
	contact += '<phone-mobile>' + options.phone_mobile + '</phone-mobile>';
    if (typeof options.title !== "undefined")
	contact += '<title>' + options.title + '</title>';
    if (typeof options.fax !== "undefined")
	contact += '<fax>' + options.fax + '</fax>';
    contact += '</contact>';
