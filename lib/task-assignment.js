...
TaskAssignment.prototype.assign = function(options, cb) {
	...
	task += '<id type="integer">' + options.task_id + '</id>';
    task += '</task>';
...
TaskAssignment.prototype.update = function(options, cb) {
	...
	task_assignment += '<billable type="boolean">' + options.billable + '</billable>';
    if (typeof options.deactivated !== "undefined")
	task_assignment += '<deactivated type="boolean">' + options.deactivated + '</deactivated>';
    if (typeof options.budget !== "undefined")
	task_assignment += '<budget type="decimal">' + options.budget + '</budget>';
    if (typeof options.hourly_rate !== "undefined")
	task_assignment += '<hourly-rate type="decimal">' + options.hourly_rate + '</hourly-rate>';
